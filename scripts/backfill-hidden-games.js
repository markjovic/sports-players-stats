...
const COOKIE_FILE   = path.join(ROOT, 'backfill-hidden-cookie.json');
const PROGRESS_FILE = path.join(ROOT, 'backfill-hidden-progress.json');
const NO_VENUE_FILE = path.join(ROOT, 'no-venue-seasons.json');
