...
const OUT_DIR     = path.join(ROOT, 'roster-results');

// ─── Paths ────────────────────────────────────────────────────────────────────

const PLAYERS_DIR = path.join(ROOT, 'players');
const COOKIE_FILE = path.join(ROOT, 'explore-cookie.json');
...
const PROGRESS_FILE = path.join(ROOT, 'roster-teams-progress.json');
