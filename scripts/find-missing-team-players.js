...
const OUTPUT_FILE  = path.join(ROOT, 'missing-team-players.json');
...
const zeroTeamSeasons  = loadSeasonIds(path.join(ROOT, 'zero-team-seasons.json'));
const noLadderSeasons  = loadSeasonIds(path.join(ROOT, 'no-ladder-seasons.json'));
