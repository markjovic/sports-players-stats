...
const MAIN_OUT      = path.join(ROOT, 'missing-game-data.json');
const BOX_OUT       = path.join(ROOT, 'missing-box-scores.json');
const QUARTER_OUT   = path.join(ROOT, 'missing-quarter-scores.json');
