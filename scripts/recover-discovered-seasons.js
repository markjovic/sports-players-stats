...
const QUEUE_PRIORITY_FILE = path.join(ROOT, 'queue-bv-priority.json');
const QUEUE_BACKLOG_FILE  = path.join(ROOT, 'queue-bv-backlog.json');
const META_FILE           = path.join(ROOT, 'seasons-discovered.json');
